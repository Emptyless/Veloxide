...
- [Introduction](./introduction/README.md)
  - [Why Rust](./introduction/why-rust.md)
...
- [Architecture](./architecture/README.md)
  ...
  - [Architecture Decision Log](./architecture/decisions/README.md)
    ...
    - [0002-use-rust-for-backend-software-development](./architecture/decisions/0002-use-rust-for-backend-software-development.md)

- [Components of Veloxide](./components/README.md)
  - [Axum Web Framework](./components/axum-web-framework.md)
  - [GraphQL](./components/graphql.md)
  - [Observability](./components/observability.md)
  - [Database](./components/database.md)

- [Getting Started](./getting-started/README.md)
  - [Prerequisites](./getting-started/prerequisites.md)
  - [Set up your project](./getting-started/set-up-your-project.md)
  - [Folder Explanations](./getting-started/folder-explanations.md)
